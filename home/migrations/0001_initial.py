    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(default=site_settings.models.get_year, help_text="Année de l'édition des interludes (ex: 2025 pour 2024-2025)", verbose_name='année')),
                ...
                ('status', models.CharField(blank=True, choices=[('P', 'En présentiel uniquement'), ('D', 'En distanciel uniquement'), ('2', 'Les deux')], default='P', max_length=1, verbose_name='Présentiel/distanciel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meal_sunday_midday', models.BooleanField(default=False, verbose_name='repas de dimanche midi')),
                ('meal_sunday_evening', models.BooleanField(default=False, verbose_name='repas de dimanche soir')),
                ('sleeps', models.BooleanField(default=False, verbose_name='dormir sur place')),
                ('paid', models.BooleanField(default=False, verbose_name='salarié(e)')),
                ('nb_murder', models.PositiveIntegerField(default=0, verbose_name='Nombre de murder réalisées')),
                ('extra_contact', models.CharField(blank=True, help_text="(Optionel) sera communiqué au MJ pour faciliter l'organisation", max_length=20, null=True, verbose_name='Numéro de téléphone')),
                ('murder_comment', models.TextField(blank=True, max_length=2000, null=True, verbose_name='Info pour MJ')),
                ('comment', models.TextField(blank=True, max_length=2000, null=True, verbose_name='Commentaire')),
